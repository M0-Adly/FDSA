  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700">
        ...
        {error && <div className="bg-red-500/10 text-red-400 p-3 rounded-lg mb-6 border border-red-500/20 text-sm">{error}</div>}
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-emerald-600 text-white p-3 rounded-lg hover:bg-emerald-700 transition font-bold text-lg shadow-lg shadow-emerald-600/20"
          >
